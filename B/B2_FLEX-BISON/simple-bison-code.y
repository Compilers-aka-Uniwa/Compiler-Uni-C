...
while_statement:
        SWHILE "(" condition ")" statement { fprintf(yyout, "[BISON] Line=%d, expression=\"Απλή δήλωση while\"\n", line); }
        | SWHILE "(" condition ")" "{" statements "}" { fprintf(yyout, "[BISON] Line=%d, expression=\"Σύνθετη δήλωση while\"\n", line); }
        ;
